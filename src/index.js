...
export const LandingPage = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { style: { position: "fixed" }, children: _jsx(LandingPageBg, { height: (boxHeight / 100) * window.innerHeight }) }), _jsxs("div", { style: {
                    position: "fixed",
                    display: "flex",
                    flexDirection: "row",
                    alignSelf: "center",
                    height: `${boxHeight}vh`,
                    width: `100vw`,
                }, children: [_jsx("img", { src: owlEyeSvg, className: "", style: {
                            width: `${imgSize}vw`,
                            height: `${imgSize}vw`,
                            alignSelf: "center",
                            ...
                            background: "linear-gradient(to right, #903030, #903090, #303090, #309090, #309030, #909030, #903030)",
                            backgroundClip: "text",
                            WebkitBackgroundClip: "text",
                            WebkitTextFillColor: "transparent",
                            marginLeft: `${textLeftMargin}vw`,
                            //background,
                        }, children: [" ", "[dave@dyslectric ~]", " "] })] }), _jsx("div", { style: {
                    width: "100vw",
                    height: `${100 + 8 * landingNavAnimation}vh`,
                    //backgroundColor: "#000000",
                } })] }));
};
ReactDOM.createRoot(document.getElementById("root")).render(_jsx(React.StrictMode, { children: _jsx(LandingPage, {}) }));
