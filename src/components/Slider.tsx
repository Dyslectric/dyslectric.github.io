...
export const Slider: FC<SliderProps> = ({
  ...
  const startPixel =
    orientation == "horizontal"
      ? barPadding
      : boxHeight - barPadding - barHeight;
  //const endPixel =
  //    orientation == "horizontal" ? boxWidth - barPadding - barWidth : ;
  const endPixel =
    orientation == "horizontal" ? boxWidth - barPadding - barWidth : barPadding;
  ...
  const barX =
    orientation == "horizontal"
      ? useMemo(
          () => startPixel + (endPixel - startPixel) * sliderValue,
          [sliderValue],
        )
  ...
  const mouseMove = useCallback(
    (event: FederatedMouseEvent) => {
      if (activated) {
        ...
        const movement =
          (orientation == "vertical"
            ? mouseY - mouseInitPos.y
            : mouseX - mouseInitPos.x) / range;
